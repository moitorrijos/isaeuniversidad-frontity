...
import Boton from '../components/primary-button'
...
const SlimHero = ({ state, background, bgColor, featured_image, title, description, enlace,texto_btn }) => {
      ...
      <MainContainer>
        <Grid columns="2" gap="40px">
          ...
          <DescriptionContainer>
            ...
            <Boton link={enlace} >Oferta Académica</Boton>
          </DescriptionContainer>
        </Grid>
      </MainContainer>
    </SlimHeroContainer>
